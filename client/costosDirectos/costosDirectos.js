		 	...
		 	_.each(zamaArray, function(costoTotal){
		 		...
		 		var totalDiferencia = 0.00;
		 			_.each(rc.getReactively("periodosCostos"), function(periodo){
		   			...
		   			// 	_.each(rc.getReactively("periodosCostos"), function(costoPeriodo){
		   			// 		var totalFinal = 0.00;
		   			// 		if(costoPeriodo.partida_id == partida._id && costoPeriodo.costo_id == costo._id){
		   			// 			_.each(presupuesto.costos, function(costoPresupuesto){
		   			// 				if("undefined" == typeof periodosCostos[partida.nombre + " - " + costoPresupuesto.nombre]){

		   			// 					periodosCostos[partida.nombre + " - " + costoPresupuesto.nombre] = {};

		   			// 					periodosCostos[partida.nombre + " - " + costoPresupuesto.nombre].periodo = costoPeriodo.comprasSinIva + (costoPeriodo.comprasIva) + costoPeriodo.contadoSinIva + (costoPeriodo.contadoIva)						
		   			// 				}else{
		   			// 					periodosCostos[partida.nombre + " - " + costoPresupuesto.nombre].periodo += costoPeriodo.comprasSinIva + (costoPeriodo.comprasIva) + costoPeriodo.contadoSinIva + (costoPeriodo.contadoIva)
		   			// 				}
		   			// 			});
